...
import { Wifi, Lock, User, AlertCircle, Loader2, Eye, EyeOff } from 'lucide-react';
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-fg-muted hover:text-fg-primary transition-colors focus:outline-none"
                  tabIndex={-1}
                >
